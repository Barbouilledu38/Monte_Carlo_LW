...
atmosphere="${path_Simu}/atms/ecrad_opt_prop_EMPTATM.txt"
...
for file in "${path_transect}/Data/sensibilite_lapse_rate_90"/*; do
    ...
    materials="${path_Simu}/materials/lavey_${lapse_rate}.mtls"
    ground="${path_Simu}/models/lavey_${lapse_rate}.obj"

    ddirectory="${path_transect}/Data/sensibilite_lapse_rate_90/$lapse_rate"
