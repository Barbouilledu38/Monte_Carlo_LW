...
altitude_snow=800
materials="${path_Simu}/materials/lavey_00.mtls"
ground="${path_Simu}/models/lavey_00.obj"

for file in "${path_transect}/Data/sensibilite_n_chemin_"/*; do

    n_chemin=${file: -2:2}
    ddirectory="${path_transect}/Data/sensibilite_n_chemin_/$n_chemin"
